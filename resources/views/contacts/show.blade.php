  ...
  <div id="contact-info" class="card shadow">
    ...
    <div class="card-body p-5">
      ...
      <div class="row align-items-center mb-4">
        ...
        <div class="col-lg-4 info-value text-muted">{{$contact->phone}}</div>

        <div class="col-lg-2">
          <i class="fa fa-envelope-o"></i> <span class="attribute">Email:</span>
        </div>
        <div class="col-lg-4 info-value text-muted">{{$contact->email}}</div>
      </div>
      ...
      <div class="row align-items-center mb-4">
        ...
        <div class="col-lg-4 info-value text-muted">{{$contact->zipcode}}</div>

        <div class="col-lg-2">
          <i class="fa fa-globe"></i> <span class="attribute">State:</span>
        </div>
        <div class="col-lg-4 info-value text-muted">{{$contact->state}}</div>
      </div>
      ...
      <div class="row align-items-center mb-4">
        ...
        <div class="col-lg-4 info-value text-muted">{{$contact->city}}</div>

        <div class="col-lg-2">
          <i class="fa fa-building-o"></i> <span class="attribute">Neighbourhood:</span>
        </div>
        <div class="col-lg-4 info-value text-muted">{{$contact->neighbourhood}}</div>
      </div>
      ...
      <div class="row align-items-center mb-4">
        ...
        <div class="col-lg-4 info-value text-muted">{{$contact->street}}</div>

        <div class="col-lg-2">
          <i class="fa fa-home"></i> <span class="attribute">Number:</span>
        </div>
        <div class="col-lg-4 info-value text-muted">{{$contact->number}}</div>
      </div>
